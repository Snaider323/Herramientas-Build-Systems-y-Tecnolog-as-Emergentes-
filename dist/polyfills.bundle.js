...
var IE8_DOM_DEFINE = __webpack_require__(402);
...
var asc = __webpack_require__(674);
...
var $export = __webpack_require__(2);
var shared = __webpack_require__(188)('metadata');
var store = shared.store || (shared.store = new (__webpack_require__(796))());
...
var has = __webpack_require__(36);
var toObject = __webpack_require__(32);
var IE_PROTO = __webpack_require__(275)('IE_PROTO');
...
var pIE = __webpack_require__(185);
var createDesc = __webpack_require__(94);
...
var $keys = __webpack_require__(413);
var hiddenKeys = __webpack_require__(263).concat('length', 'prototype');
...
var regexpExec = __webpack_require__(272);
...
var anObject = __webpack_require__(4);
var toLength = __webpack_require__(27);
var getIterFn = __webpack_require__(419);
var BREAK = {};
var RETURN = {};
...
(module.exports = function (key, value) {
  ...
  mode: __webpack_require__(183) ? 'pure' : 'global',
...
var defined = __webpack_require__(66);
var fails = __webpack_require__(10);
var spaces = __webpack_require__(278);
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
var isObject = __webpack_require__(11);
var fails = __webpack_require__(10);
var $iterDetect = __webpack_require__(407);
var setToStringTag = __webpack_require__(187);
var inheritIfRequired = __webpack_require__(265);
...
var isObject = __webpack_require__(11);
var setPrototypeOf = __webpack_require__(273).set;
...
var regexpFlags = __webpack_require__(181);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(91)(Function.call, __webpack_require__(68).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var aFunction = __webpack_require__(65);
var isObject = __webpack_require__(11);
var invoke = __webpack_require__(679);
...
__webpack_require__(52)(IteratorPrototype, __webpack_require__(16)('iterator'), function () { return this; });
...
var $trim = __webpack_require__(189).trim;
...
var $trim = __webpack_require__(189).trim;
var ws = __webpack_require__(278);
var hex = /^[-+]?0[xX]/;
...
var anObject = __webpack_require__(4);
var toLength = __webpack_require__(27);
var advanceStringIndex = __webpack_require__(259);
var regExpExec = __webpack_require__(186);

// @@match logic
__webpack_require__(180)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(180)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
var anObject = __webpack_require__(4);
var sameValue = __webpack_require__(416);
var regExpExec = __webpack_require__(186);

// @@search logic
__webpack_require__(180)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
var isRegExp = __webpack_require__(267);
var anObject = __webpack_require__(4);
var speciesConstructor = __webpack_require__(682);
var advanceStringIndex = __webpack_require__(259);
var toLength = __webpack_require__(27);
...
// @@split logic
__webpack_require__(180)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
...
var wksDefine = __webpack_require__(683);
var enumKeys = __webpack_require__(678);
...
if (!USE_NATIVE) {
  ...
  __webpack_require__(185).f = $propertyIsEnumerable;
...
var $iterators = __webpack_require__(420);
var getKeys = __webpack_require__(93);
var redefine = __webpack_require__(30);
var global = __webpack_require__(20);
var hide = __webpack_require__(52);
...
// import 'classlist.js';
//# sourceMappingURL=C:/Users/SNAIDER323/Desktop/Emergentes-Angular-master/Emergentes-Angular-master/src/polyfills.js.map
...
var speciesConstructor = __webpack_require__(673);
...
var gOPN = __webpack_require__(120);
var gOPS = __webpack_require__(184);
var anObject = __webpack_require__(4);
...
$export($export.P, 'Array', { copyWithin: __webpack_require__(670) });
...
var $export = __webpack_require__(2);
var $every = __webpack_require__(51)(4);
...
var $export = __webpack_require__(2);
var $forEach = __webpack_require__(51)(0);
...
var $export = __webpack_require__(2);
var $indexOf = __webpack_require__(395)(false);
var $native = [].indexOf;
...
$export($export.S, 'Array', { isArray: __webpack_require__(266) });
...
$export($export.P + $export.F * (__webpack_require__(118) != Object || !__webpack_require__(37)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(2);
var $reduce = __webpack_require__(396);
...
var $export = __webpack_require__(2);
var $some = __webpack_require__(51)(3);
...
// 20.3.4.36 / 15.9.5.43 Date.prototype.toISOString()
var $export = __webpack_require__(2);
var toISOString = __webpack_require__(676);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(52)(proto, TO_PRIMITIVE, __webpack_require__(677));
...
var $export = __webpack_require__(2);
var log1p = __webpack_require__(409);
var sqrt = Math.sqrt;
...
// 20.2.2.14 Math.expm1(x)
var $export = __webpack_require__(2);
var $expm1 = __webpack_require__(269);
...
$export($export.S, 'Math', { fround: __webpack_require__(680) });
...
var fails = __webpack_require__(10);
var gOPN = __webpack_require__(120).f;
var gOPD = __webpack_require__(68).f;
var dP = __webpack_require__(23).f;
var $trim = __webpack_require__(189).trim;
var NUMBER = 'Number';
...
var $export = __webpack_require__(2);
var _isFinite = __webpack_require__(20).isFinite;
...
var $export = __webpack_require__(2);
var isInteger = __webpack_require__(404);
var abs = Math.abs;
...
var $export = __webpack_require__(2);
var $parseFloat = __webpack_require__(414);
...
var $export = __webpack_require__(2);
var $parseInt = __webpack_require__(415);
...
var $export = __webpack_require__(2);
var toInteger = __webpack_require__(79);
var aNumberValue = __webpack_require__(394);
...
$export($export.S + $export.F * !__webpack_require__(26), 'Object', { defineProperties: __webpack_require__(411) });
...
$export($export.S + $export.F * !__webpack_require__(26), 'Object', { defineProperty: __webpack_require__(23).f });
...
var aFunction = __webpack_require__(65);
var anObject = __webpack_require__(4);
var rApply = (__webpack_require__(20).Reflect || {}).apply;
...
var rConstruct = (__webpack_require__(20).Reflect || {}).construct;
...
$export($export.S, 'Reflect', { ownKeys: __webpack_require__(681) });
...
var $export = __webpack_require__(2);
var setProto = __webpack_require__(273);
...
var gOPN = __webpack_require__(120).f;
var isRegExp = __webpack_require__(267);
var $flags = __webpack_require__(181);
...
__webpack_require__(274)('RegExp');
...
var $export = __webpack_require__(2);
var $at = __webpack_require__(276)(false);
...
var weak = __webpack_require__(675);
var isObject = __webpack_require__(11);
var fails = __webpack_require__(10);
var validate = __webpack_require__(123);
...
var Set = __webpack_require__(428);
var from = __webpack_require__(672);
var metadata = __webpack_require__(53);
var anObject = __webpack_require__(4);
var getPrototypeOf = __webpack_require__(54);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(56), __webpack_require__(810)))
